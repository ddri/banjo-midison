...
def _neo_soul_F_extended() -> GenerationRequest:
    return GenerationRequest(
        ...
        bpm=78,
        chords=[
            ChordSpec("Imaj9", 4, rootless=True),
            ChordSpec("iii7", 4, rootless=True),
            ChordSpec("vi11", 4, rootless=True),
            ChordSpec("ii9", 4, rootless=True),
        ],
        octave=4,
...
def _dorian_groove() -> GenerationRequest:
    return GenerationRequest(
        ...
        bpm=96,
        chords=[
            ChordSpec("i9", 4, rootless=True),
            ChordSpec("IV9", 4, rootless=True),
            ChordSpec("i9", 4, rootless=True),
            ChordSpec("IV9", 4, rootless=True),
        ],
        octave=4,
